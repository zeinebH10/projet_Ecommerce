  ...
  <a class="navbar-brand" href="../index.php">AXIA STORE</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="" style="font-weight: bold;">Ajouter produit</a>
        </li>
        <li class="nav-item">
...
<div class="mb-3">
  ...
  <input type="name" class="form-control " id="exampleFormControlInput1" name="image">
</div>
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Titre</label>
  <input type="name" class="form-control " id="exampleFormControlInput1"name="nom"  >
</div>
<div class="mb-3">
...
<button type="submit" class="btn btn-success" name="ajouter">Ajouter le produit</button>
</form>
