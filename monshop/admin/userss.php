  ...
  <a class="navbar-brand" href="../index.php">AXIA STORE</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href=""style="font-weight: bold;" >Gérer Les utilisateurs</a>
        </li>
...
foreach($users as $user){
    ...
    echo "<td><a href='delete_user.php?id=".$user['id']."'><i class='fa fa-trash' style='font-size: 20px; color: red;'></i></a></td>";
    echo "</tr>"; 
    echo "</tr>";
}
echo "</tbody>";
