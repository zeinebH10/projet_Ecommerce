...
if(isset($_POST['envoyer'])){
    if (!empty($_POST['email']) AND !empty($_POST['password'])) {
        ...
        if ($admin) {
            $_SESSION['zEinEB'] = $admin;
            header("Location: admin/adminsss.php"); 
        } else {
          echo '<script type="text/javascript">alert("email ou mot de passe incorrecte ");</script>';
          ;
        }
    }
}
...
<form method="post">
  ...
  <input type="submit" value="Log In" name="envoyer" />
